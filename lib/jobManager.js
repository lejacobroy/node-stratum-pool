...
//		    console.log("DEF::Blockhash::hashdigest( this"); console.log(" , args ["); console.log(arguments); console.log(" ]\n");
	...
	var blockHashscrypt;
        ...
        if (job.target.ge(headerBigNum)){
			...
			//	console.log("Before options.coin.forceSha256Dblockhash (BlockHash): " + blockHash);
		
			    if(options.coin.forceSha256Dblockhash === "true"){
					// blockHash = util.reverseBuffer(util.sha256d(headerBuffer, nTime)).toString('hex');
					// console.log("after options.coin.forceSha256Dblockhash (BlockHash): " + blockHash);
